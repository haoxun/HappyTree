...
$(function() {
	...
	$('div.project_basic_info a').click(function(event) {
		event.preventDefault();
		var display = $(this).parent();
		var modify = $(this).parent().parent().children('div[id^="modify_project"]');
	...
	$('div.project_basic_info form :button').click(function(event) {
		event.preventDefault();
		$(this).parent().parent().fadeOut('fast');
		var display = $(this).parent().parent().parent().children('div[id^="display_project"]');
...
$(function() {
	...
	$('div.project_basic_info form').submit(function(event) {
		event.preventDefault();
