...
urlpatterns = patterns('',
        ...
        url(r'^info/(?P<group_info_id>\d+)/$', 'group_info.views.show_group_page', name='group_page'),
        url(r'^list/$', 'group_info.views.show_group_list', name='group_list_page'),
        url(r'^management/(?P<group_info_id>\d+)/$', 'group_info.views.show_group_management', name='group_management_page'),
