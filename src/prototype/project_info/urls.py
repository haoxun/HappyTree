...
urlpatterns = patterns('',
    ...
    url(r'^group/(?P<project_info_id>\d+)/$', 'project_info.views.show_project_page', name='project_page'),
    url(r'^group/management/(?P<project_info_id>\d+)/$', 'project_info.views.show_project_management_page', name='project_management_page'),
)
