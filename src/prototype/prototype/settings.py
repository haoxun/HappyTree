...
import os
cur_path = os.getcwd()
sqlite3_db_path = os.path.join(cur_path, 'sqlite3_db')
media_root_path = os.path.join(cur_path, 'uploaded_file')
# endcode
...
DATABASES = {
    'default': {
        ...
        'NAME': sqlite3_db_path,                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'o28lpd*nxr3c1k3j3c4!0hh-b*p!c2y)90_$3^rwofv4qe4v!m'
